...
const FAQS_DATA = {
  ...
  teacher: [
    ...
    { q: "ما هو معرض الأعمال وكيف أستفيد منه؟", a: "معرض أعمالك هو واجهتك الاحترافية ومساحتك التسويقية الأولى؛ فهو النافذة التي يطل منها المستفهم على أسلوبك في الشرح قبل قبول عرضك. يرجى الاهتمام به وإضافة نماذج (فيديوهات قصيرة) واحرص على عنوان مميز ووصف دقيق." },
    ...
    { q: "هل يمكنني الاعتراف بالخطأ إذا لم أستطع إيصال المعلومة؟", a: "نعم، توفر المنصة خيار 'الاعتراف بالخطأ' في حال نشوب نزاع، وهذا يخفف من العقوبة الإدارية التي تطبق على حسابك." },
