...
const FAQS_DATA = {
  ...
  teacher: [
    ...
    { q: "لماذا تم رفض صورة ملفي الشخصي أو نبذتي التعريفية أو أحد أعمالي في معرض الأعمال؟", a: "تخضع كل البيانات للمراجعة البشرية. قد يتم الرفض إذا كانت الصورة غير لائقة، أو النبذة تحتوي على وسائل تواصل خارجية." }
  ]
};
