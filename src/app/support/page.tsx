...
const FAQS_DATA = {
  ...
  teacher: [
    ...
    { q: "ما هي عمولة منصة فهمني؟", a: "تقتطع المنصة عمولة قدرها 20% من قيمة كل استفهام مقابل توفير التقنية والوساطة، ويحصل المفهم على 80% من المبلغ (علماً بأن الفترة الحالية مجانية تماماً)." },
    { q: "ما هو معرض الأعمال وكيف أستفيد منه؟", a: "معرض أعمالك هو واجهتك الاحترافية ومساحتك التسويقية الأولى على المنصة؛ فهو النافذة التي يطل منها المستفهم على أسلوبك في الشرح قبل قبول عرضك. يرجى الاهتمام به وإضافة نماذج (فيديوهات قصيرة) واحرص على عنوان مميز ووصف دقيق." },
    { q: "متى يمكنني سحب أرباحي؟", a: "بعد انتهاء الجلسة وتأكيد المستفهم لتحقق هدف الاستفهام، ينتقل الرصيد إلى حسابك مباشرة ويمكنك السحب عبر أي وسيلة سحب متاحة." },
    ...
    { q: "هل يمكنني الاعتراف بالخطأ إذا لم أستطع إيصال المعلومة؟", a: "نعم، توفر منصة فهمني خيار 'الاعتراف بالخطأ' في حال نشوب نزاع، وهذا يخفف من العقوبة التي تطبق على حسابك." },
    { q: "كيف أحافظ على تقييم مرتفع؟", a: "بمراجعة تفاصيل الاستفهام جيداً قبل التقديم، الالتزام بالموعد، استخدام أسلوب مبسط، والتأكد المستمر من متابعة المستفهم لك خطوة بخطوة." },
    { q: "هل يحق لي رفض تقديم شرح لموضوع معين؟", a: "بالطبع، أنت تختار الاستفهامات التي تناسب خبرتك وتتقدم لها بعرض، وأنت غير ملزم بشرح أي شيء يزيد عن هدف الاستفهام المتفق عليه." },
    { q: "ما لو انقطع الإنترنت لدي أثناء الجلسة؟", a: "يجب عليك محاولة العودة فوراً. إذا تكرر الأمر، قد يؤدي ذلك لفتح شكوى من المستفهم وضياع قيمة الجلسة عليك." },
    { q: "هل يمكنني تعديل عرضي بعد تقديمه؟", a: "لا يمكنك تعديل قيمة العرض أو تفاصيله بعد نشره، لذلك احرص جيداً على الدقة قبل الضغط على إرسال." },
    { q: "لماذا تم رفض صورة ملفي أو نبذتي أو أعمالي؟", a: "تخضع البيانات للمراجعة اليدوية؛ قد يتم الرفض إذا كانت غير لائقة، أو تحتوي على وسائل تواصل خارجية، أو تخالف سياسة المنصة." }
  ]
};
