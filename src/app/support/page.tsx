...
const FAQS_DATA = {
  general: [
    ...
    { q: "كيف تضمن المنصة خصوصية المستخدمين؟", a: "تتبع فهمت سياسة صارمة؛ فالمستفهم الذكر لا يظهر استفهامه إلا للمفهمين الذكور، والعكس صحيح للإناث. كما أننا نراجع يدوياً كافة الصور الشخصية ونصوص الاستفهامات قبل نشرها لضمان بيئة آمنة." },
    ...
    { q: "ما هو الإجراء المتبع في حال حدوث خلاف أثناء الجلسة؟", a: "تعتمد المنصة على تسجيل الجلسة كمرجع أساسي (وهو تسجيل مؤقت يحذف نهائياً في حالة عدم وجود شكوى). في حال وجود شكوى، يقوم فريق الدعم الفني بمراجعة التسجيل والتحكيم بين الطرفين بناءً على محتوى الشرح." }
  ],
  student: [
    ...
    { q: "كيف أختار أفضل مفهم من بين المتقدمين؟", a: "يمكنك تصفح الملف الشخصي لكل منهم، والاطلاع على تقييمات المستفهمين السابقين له، ومراجعة معرض أعماله للتأكد من خبرته في موضوعك." },
    ...
    { q: "ما هي طرق الدفع المتاحة؟", a: "توفر فهمت وسائل دفع آمنة تشمل البطاقات الائتمانية والمحافظ الإلكترونية، ويبقى المبلغ معلقاً لدى المنصة حتى تؤكد فهمك للمعلومة." },
    { q: "ما هو أقل سعر يمكنني وضعه للاستفهام؟", a: "الآن وحتى انتهاء الفترة المجانية سعر الاستفهام هو صفر، أما بعد ذلك فالحد الأدنى هو 50 جنيهاً مصرياً، ويمكنك زيادته لجذب مفهمين أكثر كفاءة." }
  ],
  teacher: [
    { q: "كيف أبدأ بتقديم عروض تفهيم؟", a: "يجب عليك أولاً إكمال ملفك الشخصي وتوثيق هويتك. بعد موافقة الإدارة، يمكنك البدء في تقديم العروض على الاستفهامات المفتوحة." },
    ...
    { q: "ما هو معرض الأعمال وكيف أستفيد منه؟", a: "معرض أعمالك هو واجهتك الاحترافية؛ فهو النافذة التي يطل منها المستفهم على أسلوبك. ننصح بإضافة فيديوهات قصيرة تشرح مهارات تتقنها لكسب ثقة الطلاب." },
    { q: "متى يمكنني سحب أرباحي؟", a: "بعد انتهاء الجلسة وتأكيد المستفهم لتحقق هدف الاستفهام، ينتقل الرصيد إلى حسابك مباشرة ويمكنك السحب عبر أي وسيلة متاحة." },
    ...
    { q: "هل يمكنني الاعتراف بالخطأ إذا لم أستطع إيصال المعلومة؟", a: "نعم، توفر فهمت خيار 'الاعتراف بالخطأ' في حال نشوب نزاع، وهذا يخفف من العقوبة الإدارية التي قد تطبق على حسابك." }
  ]
};
  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto space-y-16 mb-24 text-right" dir="rtl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-r-8 border-primary pr-6">
        <div>
          <h1 className="text-4xl md:text-5xl font-black font-headline">مركز المساعدة والأسئلة</h1>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            {FAQS_DATA.general.map((faq, i) => (
              <AccordionItem key={i} value={`gen-${i}`} className="border-2 rounded-[2rem] bg-white px-6 overflow-hidden">
                <AccordionTrigger className="text-xl font-black text-zinc-800 hover:no-underline py-6">{faq.q}</AccordionTrigger>
                <AccordionContent className="text-lg font-bold text-zinc-500 leading-relaxed pb-6 border-t pt-4">{faq.a}</AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
        </div>
