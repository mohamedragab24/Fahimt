...
const FAQS_DATA = {
  ...
  teacher: [
    ...
    { q: "ما هو معرض الأعمال وكيف أستفيد منه؟", a: "معرض أعمالك هو واجهتك الاحترافية؛ فهو النافذة التي يطل منها المستفهم على أسلوبك في الشرح قبل قبول عرضك. احرص على إضافة نماذج شرح مميزة." },
