...
const FAQS_DATA = {
  general: [
    ...
    { q: "يمكنني استخدام حسابي كمستفهم ومفهم في نفس الوقت؟", a: "نعم، بضغطة زر واحدة يمكنك التحول من واجهة المستفهم لطلب المساعدة، إلى واجهة المفهم لتقديم عروضك ومساعدة الآخرين دون الحاجة لإنشاء حسابين." },
    ...
    { q: "ما هو الإجراء المتبع في حال حدوث خلاف أثناء الجلسة؟", a: "تعتمد المنصة على تسجيل الجلسة كمرجع أساسي وهو تسجيل مؤقت يحذف نهائياً في حالة عدم وجود شكوى أو خلاف) في حال وجود شكوى، يقوم فريق الدعم الفني بمراجعة التسجيل والتحكيم بين الطرفين بناء على محتوى الشرح." }
  ],
  student: [
    ...
    { q: "ما هي طرق الدفع المتاحة؟", a: "توفر وسائل دفع آمنة تشمل البطاقات الائتمانية والمحافظ الإلكترونية، ويبقى المبلغ معلقاً لدى المنصة حتى تؤكد فهمك للمعلومة." },
  ...
  teacher: [
    ...
    { q: "ما هي عمولة منصة فهمت؟", a: "تقتطع المنصة عمولة قدرها 20% من قيمة كل استفهام مقابل توفير التقنية والوساطة، ويحصل المفهم على 80% من المبلغ (علماً بأن الفترة الحالية مجانية تماماً)." },
    { q: "ما هو معرض الأعمال وكيف أستفيد منه؟", a: "معرض أعمالك هو واجهتك الاحترافية ومساحتك التسويقية الأولى على المنصة؛ فهو النافذة التي يطل منها المستفهم على أسلوبك في الشرح قبل قبول عرضك، لذلك يرجى الاهتمام به جيداً وإضافة نماذج على هيئة فيديوهات قصيرة في شرح أهم المهارات التي تتقنها واحرص على كتابة عنوان مميز ووصف دقيق لكل عمل." },
    { q: "متى يمكنني سحب أرباحي؟", a: "بعد انتهاء الجلسة وتأكيد المستفهم لتحقق هدف الاستفهام، ينتقل الرصيد إلى حسابك مباشرة ويمكنك السحب عن طريق أي وسيلة سحب متاحة على المنصة." },
    ...
    { q: "كيف أحافظ على تقييم مرتفع؟", a: "يمكنك المحافظة على تقييم مرتفع بعدم التقدم بعروض تفهيم إلا بعد قراءة تفاصيل الاستفهام جيداً، التأكد من قدرتك على تحقيق هدف الاستفهام، الالتزام بالموعد، استخدام أسلوب شرح مبسط، والتأكد من المستفهم خلال الجلسة أنه يتابعك خطوة بخطوة." },
    ...
    { q: "ماذا لو انقطع الإنترنت لدي أثناء الجلسة؟", a: "يجب عليك محاولة العودة فوراً. إذا تكرر الأمر، قد يؤدي ذلك لفتح شكوى من المستفهم وضياع قيمة الجلسة عليك، لذا تأكد من استقرار اتصالك." },
    ...
    { q: "لماذا تم رفض صورة ملفي الشخصي أو نبذتي التعريفية أو أحد أعمالي في معرض الأعمال؟", a: "تخضع كل البيانات للمراجعة اليدوية وقد يتم الرفض إذا كانت الصورة غير لائقة، أو النبذة تحتوي على وسائل تواصل خارجية أو عبارات تخالف سياسة المنصة أو العمل غير مطابق للمواصفات." }
  ]
};
