  ...
  return (
    <div className="p-6 md:p-10 max-w-6xl mx-auto space-y-12 mb-20" dir="rtl">
      <div className="text-center space-y-4">
        ...
        <h1 className="text-4xl md:text-6xl font-black font-headline tracking-tight text-zinc-900">الدليل الإرشادي لمنصة فهمت</h1>
      ...
      <Tabs defaultValue="student" className="w-full">
        ...
        <TabsContent value="student" className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <GuideCard icon={FileText} title="وصف المشكلة" content="ننصح المستفهم بكتابة كافة تفاصيل الجزئية التي يريد فهمها ليصل إلى المفهم المناسب في فهمت." />
            <GuideCard icon={Target} title="أهداف الاستفهام" content="اكتب الهدف النهائي الذي تريد الوصول له بوضوح؛ فهو المرجع في حال تقديم شكوى لإدارة فهمت." />
            ...
            <GuideCard icon={BadgeCent} title="الميزانية والموعد" content="ضع سعراً يتناسب مع صعوبة المعلومة؛ فالميزانية الجيدة تجذب مفهمين أكثر كفاءة في المنصة." />
            <GuideCard icon={Wallet} title="شحن الرصيد" content="يتم الشحن عبر الوسائل المتاحة في فهمت، ويظل المبلغ 'معلقاً' حتى تنتهي من فهم معلومتك تماماً." />
            <GuideCard icon={RefreshCcw} title="استعادة الرصيد" content="يمكنك استعادة الرصيد المشحون وغير المستخدم بتقديم طلب سحب عبر الوسائل الرسمية." />
            <GuideCard icon={ClipboardList} title="مراجعة العروض" content="قارن بين تقييمات المفهمين وخبراتهم في معرض أعمالهم في فهمت قبل قبول أي عرض." />
            ...
            <GuideCard icon={Mic2} title="تجهيز البيئة" content="تأكد من وجودك في مكان هادئ واتصال إنترنت مستقر لضمان جودة الصوت والصورة في الجلسة." />
            <GuideCard icon={User} title="التفاعل والوقت" content="لا تخجل من مقاطعة المفهم لطلب إعادة أي نقطة؛ فالوقت ملكك والهدف هو فهمك التام." />
            ...
            <GuideCard icon={UserCheck} title="توثيق الهوية" content="تستطيع الاستفادة من أول استفهام فقط قبل أن يطلب منك توثيق هويتك رسمياً في فهمت." />
            ...
            <GuideCard icon={Wrench} title="المهارات اليدوية" content="يمكنك طلب شرح طرق التصليح أو الطبخ أو أي مهارة يدوية وحرفية أخرى عبر فهمت." />
            <GuideCard icon={Star} title="تقييم الجلسة" content="لا تنس وضع تقييم حقيقي بعد الانتهاء؛ فهو يساعد غيرك على اختيار المفهم الأفضل في فهمت." />
          </div>
          <AlertBox title="الممنوع الاستفهام عنه" content="يمنع منعاً باتاً طلب استفهام في أي شيء مخالف للشرع أو القانون، أو الاستشارات الطبية والقانونية والدينية عبر منصة فهمت." />
        </TabsContent>

        <TabsContent value="teacher" className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <GuideCard icon={Briefcase} title="معرض الأعمال" content="ضع نماذج شرح (فيديوهات قصيرة) تعبر عن مهاراتك لزيادة فرص اختيارك من طلاب فهمت." />
            <GuideCard icon={Clock} title="اللتزام بالمواعيد" content="تقديمك للعرض يعني تفرغك التام في الموعد المحدد؛ احرص على التواجد في الموعد." />
            <GuideCard icon={ShieldCheck} title="التحقق من التخصص" content="لا تقدم عروضاً على مواضيع لا تتقنها؛ فالجودة المنخفضة قد تؤدي لإيقاف حسابك في فهمت." />
            <GuideCard icon={Download} title="سحب الأرباح" content="تنتقل الأرباح لرصيدك فور تأكيد الطالب فهمه، ويمكنك سحبها عبر وسائل الدفع المتاحة في فهمت." />
            <GuideCard icon={UserCheck} title="توثيق الهوية" content="يجب عليك توثيق هويتك كخبير قبل التمكن من تقديم أول عرض تفهيم رسمي في المنصة." />
            ...
            <GuideCard icon={Mic2} title="تجهيز البيئة" content="تأكد من الهدوء واستقرار الإنترنت لتقديم شرح احترافي يليق بخبرتك ويحفظ تقييمك في فهمت." />
            <GuideCard icon={AlertTriangle} title="الانسحاب الطارئ" content="في حال تعذر الإكمال لظرف طارئ، يجب إبلاغ الطرف الآخر فوراً وفتح تذكرة دعم في فهمت." />
          </div>
          <AlertBox title="الممنوع تفهيمه" content="يمنع تماماً تقديم تفهيم في أي شيء مخالف للشرع أو القانون، أو تقديم استشارات طبية أو قانونية أو دينية عبر فهمت." />
        </TabsContent>
      </Tabs>
    </div>
  );
