  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-12 mb-20" dir="rtl">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground text-xl leading-relaxed font-bold">كيف تتعامل منصة "فهمني" مع بياناتك؟</p>
        <div className="max-w-2xl mx-auto p-6 bg-primary/5 rounded-3xl border-2 border-dashed border-primary/20">
          <p className="text-zinc-700 leading-relaxed font-medium">
            تلتزم منصة فهمني بحماية خصوصيتك وتأمين بياناتك عند تصفح موقعنا أو التواصل معنا رقمياً. يوضح هذا البيان كيفية جمع واستخدام المعلومات الشخصية التي تقدمها لنا لضمان بيئة تعليمية آمنة وموثوقة.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8">
        <PrivacySection 
          ...
          content="يقر المستخدم سواء كان مديراً أو مستخدماً بأنه المسؤول الأول والوحيد عن كيفية استخدامه للمنصة. وتخلي إدارة فهمني مسؤوليتها، إلى أقصى حد يسمح به القانون عن أي أضرار أو خسائر مادية أو معنوية ناتجة عن استخدام الموقع، أو سوء فهم المحتوى التعليمي، أو العجز التقني عن الدخول للمنصة."
        />

        <PrivacySection 
          icon={Activity} 
          title="استمرارية الخدمة والأعطال التقنية" 
          content="تعمل إدارة فهمني جاهدة لضمان استقرار المنصة على مدار الساعة؛ ومع ذلك، قد تطرأ بعض الأعطال التقنية أو فترات التحديث الضرورية التي قد تؤدي لانقطاع مؤقت أو تأخير في الاستجابة. في هذه الحالات، نرجو من المستخدمين التحلي بالصبر حتى تعود الأنظمة للعمل بكفاءتها المعتادة."
        />
        ...
        <PrivacySection 
          ...
          content="تنفرد فهمني بتطبيق معايير الخصوصية الاجتماعية التي تضمن توجيه طلبات الإناث للمفهمات، وطلبات الذكور للمفهمين فقط، وذلك احتراماً للقيم المجتمعية وضماناً لتوفير بيئة تعليمية مريحة ومنتجة للطرفين."
        />
        ...
        <PrivacySection 
          ...
          content="جميع المحتويات المنشورة على المنصة محمية بموجب قوانين الملكية الفكرية. بمجرد اشتراكك فأنت توافق على احترام حقوق النشر الخاصة بالمنصة وبالشروحات المقدمة داخل الجلسات، ويمنع تداولها خارج إطار 'فهمني' دون إذن كتابي."
        />
      </div>
