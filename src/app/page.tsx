...
const FAQS = [
  ...
  { q: "كيف تضمن المنصة خصوصية المستخدمين؟", a: "تتبع فهمت سياسة صارمة؛ فالمستفهم الذكر لا يظهر استفهامه إلا للمفهمين الذكور، والعكس صحيح للإناث. كما نراجع يدوياً كافة الصور الشخصية ونصوص الاستفهامات لضمان بيئة آمنة." },
